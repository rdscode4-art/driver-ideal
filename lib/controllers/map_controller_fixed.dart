  ...
  Future<void> loadPassengerPickupLocations() async {
    try {
      ...
      if (response['success'] == true) {
        ...
        // Add markers for passenger pickup locations (green for regular, orange for multi-stop)
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Ride details header with multi-stop indicator
            Row(
              children: [
                Icon(
                  ride.isMultiStop ? Icons.alt_route : Icons.location_on,
                  color: ride.isMultiStop ? Colors.orange[700] : Colors.green[700],
                  size: 24
                ),
                const SizedBox(width: 12),
                Text(
                  ride.isMultiStop ? 'Multi-Stop Ride Request' : 'Ride Request',
            ...
            // Show multi-stop information if available
            if (ride.isMultiStop) ...[
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.alt_route, color: Colors.orange[700], size: 16),
                        const SizedBox(width: 8),
                        Text(
                          'Additional Stops',
                          style: TextStyle(
            ...
            _buildRideDetailRow('Final Destination', ride.dropoffLocation, Icons.location_on),
            const SizedBox(height: 8),
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: ride.isMultiStop ? Colors.orange[700] : Colors.green[700],
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Icon(
                  ride.isMultiStop ? Icons.alt_route : Icons.navigation,
                  color: ride.isMultiStop ? Colors.orange[700] : Colors.blue[700],
                  size: 24
                ),
                const SizedBox(width: 12),
                Text(
                  ride.isMultiStop ? 'Multi-Stop Navigation Request' : 'Navigation Pickup Request',
                  style: const TextStyle(
                    fontSize: 20,
                    fontWeight: FontWeight.bold,
                  ),
