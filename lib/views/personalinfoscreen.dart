...
class NonVehiclePersonalInfoScreen extends StatefulWidget {
  ...
  @override
  State<NonVehiclePersonalInfoScreen> createState() =>
      _NonVehiclePersonalInfoScreenState();
}

class _NonVehiclePersonalInfoScreenState
  ...
  Future<void> _pickProfileImage() async {
    try {
      ...
      if (pickedFile != null) {
        ...
        File convertedFile = await _convertToJpeg(
          originalFile,
          'profile_image',
        );
