...
//         print('✅ Successfully loaded ${subscriptionPlans.length} subscription plans');
...
//       hasError.value = true;
//       errorMessage.value = 'Failed to load subscription plans. Please check your internet connection and try again.';
...
//       ),
//     ];
//     print('📦 Created fallback subscription plans');
//   }
