            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  _buildContactItem(Icons.business, 'Company Name', 'RiDeal Mobility Drive Pvt. Ltd.'),
                  const SizedBox(height: 10),
                  _buildContactItem(Icons.location_city, 'Company Address', 'Ward No. 24, Kalikapur, Palabani Chhak\nMayurbhanj, Baripada, Odisha – 757001\nIndia'),
                  const SizedBox(height: 10),
                  _buildContactItem(Icons.email, 'Email', 'info@ridealmobility.com'),
                  const SizedBox(height: 10),
                  _buildContactItem(Icons.phone, 'Contact Number', '+91-9040545756'),
                  const SizedBox(height: 10),
